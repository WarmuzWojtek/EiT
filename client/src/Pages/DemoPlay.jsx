      ...
      <PlayBackground>
        ...
        <PlaygroundContainer>
          ...
          <ActionsContainer>
            ...
            />
            <Modal ref={modalRef}>
              <h3 className="modalTitle">Demoplay Module</h3>
              {words.map((word) => (
                <div key={word.a} className="modalContainer">
                  <p className="modalWord">{word.q}</p>
            ...
            <RulesContainer>
              ...
              <Subtitle
                content='Here are some words to translate. Choose from which language you want to translate, and hit "start" button. Enter a translated word into "your answer" field and hit enter. At the end you will see your score.'
                className="rulesDescription"
              />
              <LanguageSwitch
                isEnglishFirst={isEnglishFirst}
                onClickFn={handleLanguageSwitch}
              />
            </RulesContainer>
          </ActionsContainer>
        </PlaygroundContainer>
